...
impl File {
    ...
    pub fn hash(&self) -> u64 {
        match self {
            File::A => 5817909130368002898,
            File::B => 10277360981809177654,
            File::C => 12069456792742136857,
            File::D => 4677451782987899042,
            File::E => 8101572797189331230,
            File::F => 14849164300305641400,
            File::G => 5569842507474123651,
            File::H => 1186891480507330161,
        }
    }
}
